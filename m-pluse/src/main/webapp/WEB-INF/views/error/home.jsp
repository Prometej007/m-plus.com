...
<body>
	...
	<nav class="nav">
		<div class="nav1">
			<div class="navmenu">
				<a href="#we" class="navtag">WE</a> <a href="#work" class="navtag" id="work">WORK</a>
				<a href="#blog" class="navtag" id="BLOG">BLOG</a> <a href="#gall"
					class="navtag" id="GALLARY">GALLARY</a> <a href="#cont" class="navtag" id="contact">CONTACT</a>
			</div>
	...
	<div class="navslide"
		...
		<p class="textbott">
			Give us a chance <br> <font color="#e2db19" id="callus">Call us</font>
		</p>
